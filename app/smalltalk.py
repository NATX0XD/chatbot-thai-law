...
CAPABILITIES = (
    ...
    "คลังมีทั้งพระราชบัญญัติ ประมวลกฎหมายแพ่งและพาณิชย์ ประมวลกฎหมายอาญา "
    "และ พ.ร.บ.คอมพิวเตอร์ จึงตอบเรื่องเช่าบ้าน มัดจำ กู้ยืม ค้ำประกัน ครอบครัว มรดก "
    "หมิ่นประมาท ฉ้อโกง และการแฮกหรือโพสต์ข้อมูลเท็จ ได้ด้วย\n\n"
    "สิ่งที่ผมยังตอบไม่ได้ คือขั้นตอนทางคดี เช่น การแจ้งความ การประกันตัว การบังคับคดี "
    "และเรื่องประกันสังคม เพราะคลังยังไม่มีตัวบทเหล่านั้น ผมจะบอกตรง ๆ ไม่เดาให้ครับ"
)
...
EXAMPLES = (
    ...
    "• ซื้อของออนไลน์แล้วของไม่ตรงปก ร้องเรียนที่ไหน\n\n"
    "⚖️ ประมวลกฎหมาย\n"
    "• พ่อเสียชีวิตไม่ได้ทำพินัยกรรม มรดกตกทอดแก่ใคร\n"
